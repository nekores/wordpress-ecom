 ...
 * Modern Single Product Content with Tailwind CSS
 *
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( 'single-product-wrapper bg-white rounded-2xl shadow-lg overflow-hidden mb-8', $product ); ?>>
